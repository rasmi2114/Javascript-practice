...
//? Definition: A callback function is a function passed as an argument to another function and is
...
// Callback function
        ...
        // // Function to be used as a greetUser
        // function greetUser(name) {
        //     console.log(`Hello! ${name}`);
        // }

        // processUserInput("Vinod", greetUser);  //processUserInput is a higher order function
...
//? Display the results of the operations.
        ...
        console.log(mathOperation(5, 3, add));
        console.log(mathOperation(5, 9, sub));